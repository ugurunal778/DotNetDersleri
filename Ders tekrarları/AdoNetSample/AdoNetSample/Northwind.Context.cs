...
namespace AdoNetSample
{
    ...
    public partial class xfvkxruc_northwindEntities : DbContext
    {
        public xfvkxruc_northwindEntities()
            : base("name=xfvkxruc_northwindEntities")
        {
        }
        ...
        public virtual int spr_Northwind_AddCategory()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spr_Northwind_AddCategory");
        }
    
        public virtual int spr_Northwind_DeleteCategory()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spr_Northwind_DeleteCategory");
        }
    
        public virtual ObjectResult<spr_Northwind_GetCategory_Result> spr_Northwind_GetCategory()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spr_Northwind_GetCategory_Result>("spr_Northwind_GetCategory");
        }
    
        public virtual ObjectResult<spr_Northwind_InsertUpdateDelete_Result> spr_Northwind_InsertUpdateDelete()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spr_Northwind_InsertUpdateDelete_Result>("spr_Northwind_InsertUpdateDelete");
        }
    
        public virtual int spr_Northwind_UpdateCategory()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spr_Northwind_UpdateCategory");
        }
