...
namespace durer2.Controllers
{
    public class AdminController : BaseController
    {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult PageEdit([Bind(Include = "Title, Content, LocaleId")] PageDto page, HttpPostedFileBase ImageUrl)
        {
            string imgUrl = null;
            if (ImageUrl != null)
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult PageAdd(int id, [Bind(Include = "ParentId, Title, Content")] PageDto page, HttpPostedFileBase ImageUrl)
        {
            string imgUrl = null;
            if (ImageUrl != null)
            {
        ...
        [ValidateInput(false)]
        [UserAuthorize]
        public ActionResult NewsEdit([Bind(Include = "Title, Content, LocaleId")] NewsDto news, string CreateDate)
        {
            if (news.Title != null)
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult NewsAdd([Bind(Include = "Title, Content")] NewsDto news, string CreateDate)
        {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MediaAdd([Bind(Include = "CategoryId, Title, ImageUrl")] ContentDto content, HttpPostedFileBase ImageUrl, HttpPostedFileBase FileUrl)
        {
            string imgUrl = null;
            if (ImageUrl != null)
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult MediaEdit(int id, [Bind(Include = "Title, LocaleId")] ContentDto content, HttpPostedFileBase ImageUrl, HttpPostedFileBase FileUrl)
        {
            string imgUrl = null;
            if (ImageUrl != null)
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult CatalogAdd([Bind(Include = "CategoryId, FileTitle, FileUrl, ImageUrl")] ContentDto content, HttpPostedFileBase FileUrl, HttpPostedFileBase ImageUrl)
        {
            string flUrl = null;
            if (FileUrl != null)
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult CatalogEdit(int id, [Bind(Include = "FileTitle, LocaleId")] ContentDto content, HttpPostedFileBase FileUrl, HttpPostedFileBase ImageUrl)
        {
            string flUrl = null;
            if (FileUrl != null)
            {
