...
namespace At_Yarisi
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e) { SetComboBoxValues(); }
        ...
        public void AreYouWin(string finishedHorseName)
        {
            ...
            if (selectedHorse == winnerHorseLabel.Text)
            {
                ...
                MessageBox.Show("Tebrikler kazandiniz... Yatirdiginiz Tutar: " + txtBahis.Text + " Kazandiginiz Tutar: " + calculateProfit);
            }
            else
                MessageBox.Show("Kazanan At " + winnerHorseLabel.Text + "Kaybettiniz. Kaybettiginiz Tutar: " + txtBahis.Text);
