...
namespace WCFService
{
    ...
    public class MvcSampleWcf : BaseMvcSampleWcf, IMvcSampleWcf
    {
        ...
        public IList<UserInfoDto> GetUserInfoAll(string userName, string password)
        {
            if (UserAuthenticationService.CheckUserNamePassword(userName, password))
            {
                return UserInfoService.GetUserInfoAll(userName,password);
            }
            else
            {
                return null;
